...
const App: React.FC = () => {
  ...
  useEffect(() => {
    const fetchInsight = async () => {
      try {
        ...
        // Fallback is handled inside getAIInsight, but we catch top-level errors just in case
        setInsight({
          quote: "The best way to predict the future is to invent it.",
          advice: "Focus on creating value and solving real problems."
        });
      } finally {
        setLoading(false);
      }
  ...
  return (
    <div className="relative min-h-screen flex flex-col overflow-hidden bg-[#030712] selection:bg-blue-500/30 text-white">
        ...
        <section className="mb-16">
          <div className="glass p-6 md:p-8 rounded-3xl border-blue-500/20 bg-blue-500/5">
            <div className="flex items-start space-x-4">
              <div className="mt-1 p-2 rounded-xl bg-blue-500/10 text-blue-400 shrink-0">
              ...
              <div className="flex-grow min-w-0">
                ...
                {loading ? (
                  ...
                  <>
                    <p className="text-xl md:text-2xl font-medium text-white mb-2 leading-snug break-words">
                      "{insight?.quote}"
                    </p>
      ...
      {/* Footer */}
      <footer className="relative z-10 px-6 py-10 md:px-12 border-t border-white/5 bg-white/2 mt-auto">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 text-white/40 text-sm">
          ...
          <div className="flex space-x-6">
            <a href="https://github.com/Kyon9" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Source</a>
